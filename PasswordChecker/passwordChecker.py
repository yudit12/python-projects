...
"""
func that convert the file of password to check to 
a list of password 
"""

def get_password_to_check(fileName):
...
"""
def main():
    password_file= 'password_to_check.txt'
    password_list=get_password_to_check(password_file)
